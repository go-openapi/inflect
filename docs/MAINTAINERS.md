...
All tests across `go-openapi` use our fork of `stretchr/inflect` (this repo): `github.com/go-openapi/inflect`.
...
<!-- links to references -->
[linter-config]: https://github.com/go-openapi/inflect/blob/master/.golangci.yml
[remote-cliff-config]: https://github.com/go-openapi/ci-workflows/blob/master/.cliff.toml
[dependabot-config]: https://github.com/go-openapi/inflect/blob/master/.github/dependabot.yaml
...
[godoc-url]: https://pkg.go.dev/github.com/go-openapi/inflect
